...
@mark.parametrize(
    ("junction", "index"), (("a", 0), ("b", 1), ("c", 1), ("d", 1), ("e", 2), ("f", 2))
)
def test_find_junction_in_circuit_list(junction, index):
    assert find_junction_in_circuit_list(junction, EXAMPLE_CIRCUITS) == index
